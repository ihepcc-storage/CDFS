...
#ifndef lint
static char sccsid[] = "@(#)Cns_setactualpath.c, 2016/08/29 10:17:30 XuQi ";
#endif /* not lint */
...
int DLL_DECL
Cns_setactualpath(const char *path, char *comment)
{
	char *actual_path;
	int c;
	char func[16];
	...
	marshall_LONG (sbp, CNS_SETACTUALPATH);

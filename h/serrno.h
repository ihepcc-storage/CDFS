...
#define EDCCBASEOFF     2600                    /* DCC error base offset*/
#define ERSBASEOFF      2700            /* Reserv Server error base offset
...
/*
 *------------------------------------------------------------------------
 * Reserv Server errors
 *------------------------------------------------------------------------
 */
#define ERSNACT         ERSBASEOFF+1    /* server not active or service being drained */
#define ERSNOSPREQ      ERSBASEOFF+2    /* can't find specified request */
#define ERSSTGFAIL	ERSBASEOFF+3    /* failed to stagein file */
#define ERSRSVFAIL	ERSBASEOFF+4	/* failed to resrve file */
#define ERSMAXERR       ERSBASEOFF+6

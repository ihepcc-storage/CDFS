/*
 * vmgr_api.h,v 1.31 2003/10/29 12:17:23 baud Exp
 */
...
/*
 * @(#)vmgr_api.h,v 1.31 2003/10/29 12:17:23 CERN IT-PDP/DM Jean-Philippe Baud
 */
...
EXTERN_C int DLL_DECL vmgr_deltag _PROTO((const char *));
EXTERN_C int DLL_DECL vmgr_enterdenmap _PROTO((const char *, char *, char *, int));
...
EXTERN_C int DLL_DECL vmgr_modifymodel _PROTO((const char *, char *, int));
...
EXTERN_C int DLL_DECL vmgr_querymodel _PROTO((const char *, char *, int *));
...
EXTERN_C int DLL_DECL vmgr_settag _PROTO((const char *, char *));
...
EXTERN_C int DLL_DECL vmgrchecki _PROTO((char *, char *, char *, char *, char *, int, uid_t, gid_t, char *));
#endif
